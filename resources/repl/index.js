...
// webview/App.tsx
function AliveREPL() {
  const [vscodeApi, setVscodeApi] = (0, import_react.useState)(null);
  const scrollReplRef = (0, import_react.useRef)(null);
  const [packageName, setPackageName] = (0, import_react.useState)("");
  const [inputText, setInputText] = (0, import_react.useState)("");
  const [outputItems, setOutputItems] = (0, import_react.useState)([]);
  const inputRef = (0, import_react.useRef)(null);
  const replOutputRef = (0, import_react.useRef)(null);
  const calledOnce = import_react.default.useRef(false);
  ...
  return /* @__PURE__ */ import_react.default.createElement("div", { className: "repl-container" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "repl-output", ref: replOutputRef }, outputItems.map(({ text, type, pkgName }, idx) => /* @__PURE__ */ import_react.default.createElement("div", { key: `repl-output-container-${idx}`, className: `repl-${type}-container` }, /* @__PURE__ */ import_react.default.createElement("div", { className: "repl-output-item" }, type === "input" && pkgName && /* @__PURE__ */ import_react.default.createElement("span", { className: "repl-output-package" }, pkgName, "> "), text)))), /* @__PURE__ */ import_react.default.createElement("div", { className: "repl-input-text-box" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "repl-input-label", onClick: onPackageClick }, packageName, ">"), /* @__PURE__ */ import_react.default.createElement("form", { className: "repl-input-form", onSubmit: handleSubmit }, /* @__PURE__ */ import_react.default.createElement(
    "input",
    {
...
root.render(
  /* @__PURE__ */ import_react2.default.createElement(import_react2.StrictMode, null, /* @__PURE__ */ import_react2.default.createElement(AliveREPL, null))
);
